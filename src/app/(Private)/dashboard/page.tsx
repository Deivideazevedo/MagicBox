...
const DashboardContent = () => {
  ...
  const isCurrentMonth =
    format(selectedDate, "MM/yyyy") === format(new Date(), "MM/yyyy");
          ...
          <Box sx={{ mb: 4 }} ref={tourRefs.welcomeRef}>
            ...
            >
              <Typography
                ...
                sx={{
                  background:
                    "linear-gradient(45deg, #5D87FF 30%, #49BEFF 90%)",
                  backgroundClip: "text",
              ...
              >
                {isCurrentMonth
                  ? `Olá, ${userName}! 👋`
                  : `Resumo de ${format(selectedDate, "MMMM", { locale: ptBR })}`}
              </Typography>
              <ProductTourButton
                onClick={() => {
                  tour.reset();
                ...
                <Grid container spacing={3} alignItems="center">
                  <Grid item xs={12} md={8}>
                    ...
                    <Typography variant="body1" sx={{ mb: 3, opacity: 0.9 }}>
                      Suas finanças estão organizadas e você tem controle total
                      sobre seus gastos. Continue assim e alcance seus objetivos
                      financeiros!
                    </Typography>
                  </Grid>
