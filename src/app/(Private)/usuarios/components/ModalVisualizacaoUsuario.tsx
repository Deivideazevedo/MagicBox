...
interface ModalVisualizacaoUsuarioProps {
  user: (User & { isOnline?: boolean }) | null;
  onClose: () => void;
      ...
      <Box>
        <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 0.2 }}>
          <Typography
            ...
            fontWeight={700}
            color="textSecondary"
            sx={{ textTransform: "uppercase", letterSpacing: 1.1 }}
          >
            {label}
          </Typography>
          {badge}
              ...
              >
                <Box sx={{ textAlign: "center", mt: 2, mb: 4 }}>
                  ...
                  <Stack direction="row" spacing={1} justifyContent="center">
                    ...
                    <Chip
                      label={
                        user.hasPassword ? "CONTA INTEGRADA" : "CONTA SOCIAL"
                      }
                      variant="outlined"
                ...
                <Stack spacing={3}>
                  ...
                  <InfoItem
                    icon={IconWorld}
                    label="Origem da conta"
                    value={user.origem || "Credenciais"}
                  />
                  <InfoItem
                    icon={IconCalendar}
                  ...
                  <Box>
                    ...
                    {isLoadingAcessos ? (
                      ...
                      <Stack spacing={2} sx={{ mt: 1, pl: 0.5 }}>
                        {acessos.map((acesso: AccessLogItem, index: number) => {
                          const isLogout =
                            acesso.provider.toLowerCase() === "logout";
                          return (
                            <Stack
                              direction="row"
                              spacing={2}
                              ...
                              <Box
                                sx={{
                                  ...
                                  "&:hover": {
                                    ...
                                    boxShadow: (theme) =>
                                      `0 4px 12px ${alpha(isLogout ? theme.palette.error.main : theme.palette.primary.main, 0.05)}`,
                                  },
                                }}
                              >
                                <Stack
      ...
      >
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            <Box>
              ...
              <Typography variant="caption" color="textSecondary">
                Auditoria detalhada para {user?.name}
              </Typography>
            </Box>
          </Stack>
        ...
        <DialogContent sx={{ p: 2, maxHeight: "60vh", overflowY: "auto" }}>
          {isLoadingTodosAcessos ? (
            ...
            <Stack spacing={1.5}>
              {todosAcessos.map((acesso: AccessLogItem) => {
                const isLogout = acesso.provider.toLowerCase() === "logout";
                return (
                  <Box
                    key={acesso.id}
                    sx={{
